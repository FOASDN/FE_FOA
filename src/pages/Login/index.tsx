        ...
        <div className="relative z-10 flex flex-col justify-end p-16 w-full h-full">
          <div className="max-w-xl">
            <h1 className="text-white text-5xl font-black leading-tight tracking-tight mb-6">
              {t('auth:login.heroTitle', 'Ăn ngon, sống khỏe với gợi ý AI thông minh.')}
            </h1>
        ...
        <div className="w-full max-w-[420px] flex flex-col gap-8">
          ...
          <div className="flex flex-col items-center text-center gap-4">
            ...
            <div className="flex flex-col gap-1">
              ...
              <p className="text-muted-foreground text-base">
                {t('auth:login.description', 'Vui lòng nhập thông tin để đăng nhập')}
              </p>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            <div className="flex flex-col gap-2">
              <label className="text-foreground text-sm font-semibold px-1">{t('auth:login.email')}</label>
              <input
                type="email"
                value={email}
            ...
            <div className="flex flex-col gap-2">
              <div className="flex justify-between items-center px-1">
                <label className="text-foreground text-sm font-semibold">{t('auth:login.password')}</label>
                <Link to="/forgot-password" className="text-orange-600 text-sm font-bold hover:text-orange-700 hover:underline">
          ...
          <p className="text-center text-foreground text-sm font-medium mt-4">
            ...
            <Link to="/register" className="text-orange-600 font-bold hover:text-orange-700 hover:underline ml-1">
              {t('auth:login.signUp')}
            </Link>
          </p>
        </div>
