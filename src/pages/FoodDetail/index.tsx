        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 backdrop-blur-md bg-black/60">
          <div className="w-full max-w-[480px] bg-white dark:bg-[#181a1b] rounded-2xl p-8 flex flex-col items-center shadow-2xl animate-in fade-in zoom-in duration-300">
            ...
            <p className="text-center text-gray-600 dark:text-gray-300 mb-6 px-4 leading-relaxed">
              Bạn đang thêm{" "}
              <span className="font-bold text-red-600">Phở Bò Tái</span> vào giỏ
              hàng.
            </p>
            ...
            <div className="w-full bg-red-50 dark:bg-red-900/10 border border-red-100 dark:border-red-900/30 rounded-xl p-4 mb-6 flex gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-red-600/80 dark:text-red-400/80 leading-relaxed">
                  AI của chúng tôi phát hiện món này chứa{" "}
                  <span className="font-bold">Mì trứng</span>, xung đột với hồ
                  sơ dị ứng của bạn.
                </p>
              </div>
            </div>
            ...
            <p className="text-xs text-center text-gray-400 mb-6 max-w-xs mx-auto">
              Vui lòng xác nhận bạn hiểu rủi ro trước khi tiếp tục. Chúng tôi
              khuyên bạn nên xem các món thay thế khác.
            </p>
            ...
            <div className="flex flex-col gap-3 w-full">
              ...
              <button
                onClick={() => {
                  setShowWarningModal(false);
                  alert("Đã thêm bất chấp cảnh báo!");
                }}
      ...
      <main className="flex-grow w-full max-w-[1440px] mx-auto px-4 md:px-10 lg:px-20 py-6 md:py-10">
          ...
          <div className="relative lg:sticky lg:top-24 h-auto lg:h-[calc(100vh-8rem)] flex flex-col">
            <div className="relative w-full h-full min-h-[400px] lg:min-h-0 rounded-2xl overflow-hidden shadow-lg group">
              <div
                ...
                style={{
                  backgroundImage:
                    'url("https://images.unsplash.com/photo-1582878826629-29b7ad1cdc43?w=800&h=800&fit=crop")',
                }}
              ></div>
              {/* Overlay Badge */}
            ...
            <div className="flex gap-4 mt-4 overflow-x-auto pb-2 scrollbar-hide">
              <button className="w-20 h-20 rounded-lg overflow-hidden border-2 border-primary shrink-0">
                <div
                  ...
                  style={{
                    backgroundImage:
                      'url("https://images.unsplash.com/photo-1582878826629-29b7ad1cdc43?w=300&h=300&fit=crop")',
                  }}
                ></div>
              </button>
              <button className="w-20 h-20 rounded-lg overflow-hidden border border-transparent opacity-60 hover:opacity-100 hover:border-gray-300 dark:hover:border-gray-600 transition-all shrink-0">
                <div
                  ...
                  style={{
                    backgroundImage:
                      'url("https://images.unsplash.com/photo-1591814468924-caf88d1232e1?w=300&h=300&fit=crop")',
                  }}
                ></div>
              </button>
              <button className="w-20 h-20 rounded-lg overflow-hidden border border-transparent opacity-60 hover:opacity-100 hover:border-gray-300 dark:hover:border-gray-600 transition-all shrink-0">
                <div
                  ...
                  style={{
                    backgroundImage:
                      'url("https://images.unsplash.com/photo-1555939594-58d7cb561ad1?w=300&h=300&fit=crop")',
                  }}
                ></div>
              </button>
            </div>
          ...
          <div className="flex flex-col h-full pt-2">
            ...
            {!isAllergic ? (
              <div className="bg-gradient-to-br from-emerald-50 to-teal-50 dark:from-emerald-900/10 dark:to-teal-900/10 border border-emerald-200 dark:border-emerald-800 rounded-2xl p-6 mb-8 transition-all duration-300 relative overflow-hidden group">
                <div className="absolute top-0 right-0 p-4 opacity-10 group-hover:opacity-20 transition-opacity">
                  <span className="material-symbols-outlined text-[100px] text-emerald-600 rotate-12">
                    health_and_safety
                  </span>
                </div>
                <div className="flex items-start gap-5 relative z-10">
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-extrabold text-[#064e3b] dark:text-emerald-400 mb-2 flex items-center gap-2">
                      ...
                      <span className="material-symbols-outlined text-emerald-600 dark:text-emerald-400 text-[20px] fill-1">
                        check_circle
                      </span>
                    </h3>
                    <p className="text-sm font-medium text-[#065f46] dark:text-emerald-300/80 mb-5 leading-relaxed max-w-md">
                      Công nghệ <span className="font-bold">NutriAI™</span> đã
                      phân tích kỹ lưỡng món ăn này để đảm bảo đủ chất dinh
                      dưỡng và an toàn cho sức khỏe của bạn.
                    </p>
                    <div className="flex flex-wrap gap-3">
                      {[
                        {
                          icon: "local_fire_department",
                          text: "Nóng hổi thơm ngon",
                          color: "text-orange-700 dark:text-orange-300",
                          bg: "bg-orange-100 dark:bg-orange-900/30",
                        },
                        {
                          icon: "fitness_center",
                          text: "Giàu Protein (28g)",
                        ...
                        <span
                          key={idx}
                          className={`inline-flex items-center gap-1.5 px-3 py-1.5 ${tag.bg} rounded-lg text-xs font-bold ${tag.color} shadow-sm border border-transparent hover:border-current transition-all`}
                        >
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-[#1b140d]/70 dark:text-white/70 mb-4 leading-relaxed">
                      Trợ lý AI nhận thấy món này có chứa thành phần bạn bị dị
                      ứng. Vui lòng cân nhắc cẩn thận trước khi đặt hàng.
                    </p>
                    <button
            ...
            <div className="mb-8">
              ...
              <p className="text-base text-gray-600 dark:text-gray-300 leading-relaxed">
                Tô phở bò tái truyền thống Hà Nội với nước dùng thanh ngọt được
                ninh từ xương trong 12 tiếng. Thịt bò tươi thái mỏng, tái chín
                vừa phải khi chan nước dùng nóng. Ăn kèm bánh phở tươi, rau
                thơm, ngò gai và chanh tươi. Hương vị đậm đà, chân thực của ẩm
                thực phố cổ.
              </p>
            </div>
            ...
            <div className="mb-8 space-y-6 border-t border-gray-100 dark:border-white/10 pt-6">
              {/* Spiciness Level */}
              <div>
                <h3 className="text-base font-bold text-text-main dark:text-white mb-3">
                  Độ cay
                </h3>
                <div className="flex flex-wrap gap-3">
              ...
              <div>
                <h3 className="text-base font-bold text-text-main dark:text-white mb-3">
                  {t("customer:foodDetail.chooseTopping")}
                </h3>
            ...
            <div className="mb-10">
              <h3 className="text-lg font-bold text-text-main dark:text-white mb-3">
                {t("customer:foodDetail.ingredients")}
              </h3>
              <ul className="grid grid-cols-2 gap-y-2 gap-x-4">
                ...
                {isAllergic && (
                  <li className="flex items-center justify-between gap-2 text-sm font-bold text-red-600 dark:text-red-400 bg-red-50 dark:bg-red-900/20 px-2 py-1 rounded">
                    ...
                    <span className="text-[10px] uppercase font-extrabold bg-red-100 dark:bg-red-900/40 px-1.5 py-0.5 rounded tracking-wide border border-red-200 dark:border-red-800">
                      Dị ứng
                    </span>
                  </li>
                )}
              ...
              <div className="flex flex-col sm:flex-row gap-4 items-stretch sm:items-center">
                ...
                <div className="flex-1 flex flex-col gap-2">
                  <button
                    ...
                    className={`w-full h-14 font-bold text-lg rounded-xl shadow-lg flex items-center justify-center gap-3 transition-all hover:-translate-y-0.5 active:translate-y-0 cursor-pointer ${
                      isAllergic
                  ...
                  >
                    {!isAllergic ? (
                      <>
                        ...
                        <span>
                          {(75000 * quantity).toLocaleString("vi-VN")}đ
                        </span>
                      </>
                    ) : (
                      <>
                  ...
                  {isAllergic && (
                    <p className="text-center text-[10px] font-bold text-red-600 dark:text-red-400 flex items-center justify-center gap-1">
                      ...
                      Vui lòng xác nhận bạn hiểu rủi ro dị ứng trước khi đặt
                      hàng.
                    </p>
                  )}
                </div>
              ...
              {[
                {
                  ...
                  date: "2 ngày trước",
                  rating: 5,
                  text: "Nước dùng thanh ngọt, thịt bò tái mềm, tan trong miệng. Phở ngon nhất tôi từng ăn ở HCM!",
                },
                {
                  name: "Hoàng Tùng",
                  date: "1 tuần trước",
                  rating: 4,
                  text: "Phở đúng vị Hà Nội, bánh phở tươi mềm. Giao hàng đúng giờ, giữ nhiệt tốt.",
                },
                {
                  name: "Thu Hà",
                  date: "2 tuần trước",
                  rating: 5,
                  text: "Tuyệt vời! Nước dùng ngọt tự nhiên từ xương, không bột ngọt. Sẽ ủng hộ lâu dài!",
                },
              ].map((review, idx) => (
                <div
                  key={idx}
                  className="bg-white dark:bg-white/5 p-5 rounded-xl border border-gray-100 dark:border-white/10"
                >
                      ...
                      <div>
                        ...
                        <div className="flex text-yellow-400 text-[14px]">
                          {[...Array(5)].map((_, i) => (
                            <span
                              key={i}
                              className={`material-symbols-outlined ${i < review.rating ? "fill-1" : ""}`}
                            >
                              star
                            </span>
                          ))}
        ...
        <section className="mb-10">
          <h2 className="text-2xl font-bold text-text-main dark:text-white mb-6">
            {t("customer:foodDetail.relatedItems")}
          </h2>
            ...
            {[
              {
                name: "Pad Thai Tôm",
                price: 135000,
                img: "https://lh3.googleusercontent.com/aida-public/AB6AXuDJIFsv1Yt0Ay3jH1Bp4-v6NQ5GYFLjB2UbwYytkKTvXwBlmD-Bnf5HcbAMIFVwHfWGYTpYJbyyJI-v6sDH62z-2Y2p4fso65vqDCI9Zbxido1-wLWijVFBdIkl9pSi9iBbTamOkQ62plUL7Ho1jlokjlGSn9iCLYkf8ElFSYqgER_rGOWLzfAIVDlprdc03uj0ajQzFLrer-H_tMrMNidtWzUbDgsxhknhLUsUK7hnnJeZtUFJ4cxkf2CX6kBOajYpP0F7yQeGzvY",
              },
              {
                name: "Súp Tom Yum",
                price: 120000,
                img: "https://lh3.googleusercontent.com/aida-public/AB6AXuA_eXW4G0uubYHfUzl7N_MXC2PcgpJzscs76Bhq2KQiyQ8Xa_S6W7Ir9Hdfy04CCCxZOEUGqrElnyFw92IS_0ZMP7ZFnB2uip-NJ5LnIX0aZcrOBfUTRpR1i5hUgiuR6UnVfFO9M1v2CatkljKRAMk6o410j-8ilIrJflbk--gF1H6tzoW4pYrxZXD2lAcczkEgR5Sruzl2dxYZLOdmbjYknSAJa68cyBTpLXsNQUQ_U-vKQ6hA9CNDu0Nr4MlDsn432mTW-gdNn9E",
              },
              {
                name: "Cà Ri Xanh",
                price: 140000,
                img: "https://lh3.googleusercontent.com/aida-public/AB6AXuBS2l5DGZFEHaiFZFN1egqQ9q2Knebt4Y8fw7gi3ak_C9Uu2sqbxs10pnKyiD4WkN5iBGZdVEhnEXUSw3jv6Kv2bCRd2eESmn89kUpPx1KEiZPKEuvXJX5OJ3NkhNyQQ2eLsrhJvXRX4KofC0Lj9zBEf-U5JiUA7B0Vb1uHXmi_owP8ZqRVU3aCU-ZV2X2bpwbxaTDY-VAyZuFLhQniDzfKr9VkCzRqgmsIYy6egwPrYM3ckJakmfQb51ptLPS3NriTY0fDfywXIKw",
              },
              {
                name: "Gỏi Xoài Cá Trê",
                price: 110000,
                img: "https://lh3.googleusercontent.com/aida-public/AB6AXuBta7V079jGQX19B6VM3WIELX_zDUYnmh7eY_dzks62za15ASJLEs1iwQeU-M0O7fO4KiwybYLHcO_6e11hQLTP8iOynGtc5s8TZ0mlfUaFWhi3Y0MFJl_JOG9yjngk3__VS2jl7WKtK6YsMmlHha2EY-pAmdcnNAfuaqeSZSVJt1ygpjyCx-5cNEpJ5djR4fSmAFmX7MPXJMQ5sNVVp7uuAEqAYnYmIJwGPs4oVlY_uCxXUA-tPdLTaxUE3gIzwe3kCvY_pMXiWnE",
              },
            ].map((item, idx) => (
              <div key={idx} className="group cursor-pointer">
                ...
                <h4 className="font-bold text-text-main dark:text-white mb-1 truncate">
                  {item.name}
                </h4>
